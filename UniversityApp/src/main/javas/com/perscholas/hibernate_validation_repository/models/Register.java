...
public class Register {
	...
	@Size(min = 3, max = 25, message = "UsertName must be between 5 and 25 characters long.")
	@NotBlank(message = "Username is required.")
	private String username;

	@Size(min = 2, max = 25, message = "firstName must be between 5 and 25 characters long.")
